...
const split_highlighted_html_js_1 = require("./split-highlighted-html.js");
const jsDiff = diff;
var DiffType;
(function (DiffType) {
 ...
 */
const computeLineInformation = (oldString, newString, disableWordDiff = false, lineCompareMethod = DiffMethod.CHARS, linesOffset = 0, showLines = [], oldRenderedLines, newRenderedLines) => {
    let diffArray = [];
    ...
    const oldHTMLLines = (0, split_highlighted_html_js_1.processRenderedLines)(oldRenderedLines);
    const newHTMLLines = (0, split_highlighted_html_js_1.processRenderedLines)(newRenderedLines);
