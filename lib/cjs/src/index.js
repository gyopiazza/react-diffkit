...
exports.DiffType = exports.DiffMethod = exports.LineNumberPrefix = void 0;
...
Object.defineProperty(exports, "DiffType", { enumerable: true, get: function () { return compute_lines_js_1.DiffType; } });
const expand_js_1 = require("./expand.js");
const styles_js_1 = __importDefault(require("./styles.js"));
const fold_js_1 = require("./fold.js");
const merge_highlighted_html_js_1 = require("./merge-highlighted-html.js");
...
class DiffViewer extends React.Component {
    constructor(props) {
         ...
         */
        this.renderWordDiff = (diffArray, renderedHTML) => {
            ...
            if (renderedHTML) {
                ...
                for (const wordDiff of diffArray) {
                    const text = wordDiff.value;
                    const length = text ? text.length : 0;
                    if (wordDiff.type === compute_lines_js_1.DiffType.ADDED) {
                        changes.push({
                            start: currentPos,
                    ...
                    else if (wordDiff.type === compute_lines_js_1.DiffType.REMOVED) {
                        changes.push({
                            start: currentPos,
                            end: currentPos + length,
                            type: "removed",
                ...
                const mergedElements = (0, merge_highlighted_html_js_1.mergeHTMLWithDiff)(renderedHTML, changes, cssClasses);
         ...
         */
        this.renderLine = (lineNumber, type, prefix, value, additionalLineNumber, additionalPrefix, renderedHTML) => {
            ...
            if (hasWordDiff) {
                ...
                content = (0, jsx_runtime_1.jsx)("span", { dangerouslySetInnerHTML: { __html: renderedHTML } });
            }
            else {
        ...
        this.renderSplitView = ({ left, right }, index) => {
            var _a, _b;
            return ((0, jsx_runtime_1.jsxs)("tr", { className: (0, classnames_1.default)(this.styles.line, (_b = (_a = this.props).lineClassNames) === null || _b === void 0 ? void 0 : _b.call(_a, { left, right })), children: [this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value, undefined, undefined, left.renderedHTML), this.renderLine(right.lineNumber, right.type, LineNumberPrefix.RIGHT, right.value, undefined, undefined, right.renderedHTML)] }, index));
        };
        /**
        ...
        this.renderInlineView = ({ left, right }, index) => {
            ...
            if (left.type === compute_lines_js_1.DiffType.REMOVED && right.type === compute_lines_js_1.DiffType.ADDED) {
                return ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [(0, jsx_runtime_1.jsx)("tr", { className: (0, classnames_1.default)(this.styles.line, (_b = (_a = this.props).lineClassNames) === null || _b === void 0 ? void 0 : _b.call(_a, { left })), children: this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value, null, undefined, left.renderedHTML) }), (0, jsx_runtime_1.jsx)("tr", { className: (0, classnames_1.default)(this.styles.line, (_d = (_c = this.props).lineClassNames) === null || _d === void 0 ? void 0 : _d.call(_c, { right })), children: this.renderLine(null, right.type, LineNumberPrefix.RIGHT, right.value, right.lineNumber, LineNumberPrefix.RIGHT, right.renderedHTML) })] }, index));
            }
            if (left.type === compute_lines_js_1.DiffType.REMOVED) {
                content = this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value, null, undefined, left.renderedHTML);
            }
            if (left.type === compute_lines_js_1.DiffType.DEFAULT) {
                content = this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value, right.lineNumber, LineNumberPrefix.RIGHT, left.renderedHTML);
            }
            if (right.type === compute_lines_js_1.DiffType.ADDED) {
                content = this.renderLine(null, right.type, LineNumberPrefix.RIGHT, right.value, right.lineNumber, undefined, right.renderedHTML);
            }
            return ((0, jsx_runtime_1.jsx)("tr", { className: (0, classnames_1.default)(this.styles.line, (_f = (_e = this.props).lineClassNames) === null || _f === void 0 ? void 0 : _f.call(_e, { left, right })), children: content }, index));
        };
        /**
         ...
         */
        this.renderDiff = () => {
            const { oldValue, newValue, splitView, disableWordDiff, compareMethod, linesOffset, oldRenderedLines, newRenderedLines, } = this.props;
            const { lineInformation, diffLines } = (0, compute_lines_js_1.computeLineInformation)(oldValue, newValue, disableWordDiff, compareMethod, linesOffset, this.props.alwaysShowLines, oldRenderedLines, newRenderedLines);
