 ...
 */
export function injectDiffTags(tree, changes, cssClasses) {
    if (changes.length === 0) {
        return tree;
    }
 ...
 */
export function treeToReactElements(tree) {
 ...
 */
export function mergeHTMLWithDiff(html, changes, cssClasses) {
    if (!html) {
        return [];
    }
